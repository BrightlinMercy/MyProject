							...
							<form:form action="${url}" modelAttribute="myaddress"
								...
								<div class="form-group">
									...
									<form:input type="text" name="address_line2"
										...
										placeholder="Address Line2" path="addline2" />
								...
								<form:hidden path="customer.custid" value="${sessionScope.customerid}" />
					...
					<div class="col-lg-4">
						<div class="thumbnail card">
							...
							<div class="caption card-body" style="font-family: Geneva">
								...
								<div class="row">
									<div class="col-xs-12">
										<p class="lead">${v.customername}<br>${v.addline1},<br>
											${v.addline2},<br> ${v.city},<br> ${v.state},<br>
											${v.pincode}.
										</p>
									</div>
								</div>
								<div class="row">
									<div class="col-xs-12">
										<a class="btn btn-success fa fa-pencil"
											href="${cr}/user/editAddress?addrid=${v.addressid}"></a> <a
											class="btn btn-success fa fa-trash"
											href="${cr}/user/deleteAddress?addrid=${v.addressid}"></a> <a
											class="btn btn-success fa fa-truck" href="${cr}/user/placeorder?addressid=${v.addressid}"></a>
									</div>
								</div>
							</div>
						</div>
