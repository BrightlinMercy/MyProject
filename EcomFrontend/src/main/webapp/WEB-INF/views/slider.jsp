...
<c:set var="cr" value="${pageContext.request.contextPath}"/>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            ...
            <div>
                <img data-u="image" src="${cr}/resources/images/image2.jpg" />
            </div>
            <div>
			...
			<div>
                <img data-u="image" src="${cr}/resources/images/image7.jpg" />
            </div>
			<div>
                <img data-u="image" src="${cr}/resources/images/image8.jpg" />
            </div>
			<div>
                <img data-u="image" src="${cr}/resources/images/image9.jpg" />
            </div>
			<div>
                <img data-u="image" src="${cr}/resources/images/image10.jpg" />
            </div>
